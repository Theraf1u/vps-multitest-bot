...
Telegram-бот, который подключается по SSH к серверу пользователя, прогоняет набор из 19
диагностических тестов (скорость, IP-репутация, гео/DPI-блокировки, бенчмарки — часть из
...
2. На экране подтверждения — «🚀 Все тесты (19)» или «🎯 Выбрать тесты»: инлайн-чеклист по
...
19 тестов сгруппированы в 4 категории (⚡ Производительность, 🌍 Сеть, 🔐 IP Quality,
